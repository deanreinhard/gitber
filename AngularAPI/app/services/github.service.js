...
var GithubService = (function () {
    function GithubService(_http) {
        this._http = _http;
        this.username = 'deanreinhard';
        this.organisationname = 'apple';
    ...
    GithubService.prototype.getOrganisation = function () {
        return this._http.get('https://api.github.com/orgs/' + this.organisationname)
            .map(function (res) { return res.json(); });
    };
    GithubService.prototype.getMembers = function () {
        return this._http.get('https://api.github.com/orgs/' + this.organisationname + '/members')
            .map(function (res) { return res.json(); });
    };
    GithubService.prototype.updateOrganisationname = function (organsationname) {
